...
const Navbar = () => {
    ...
    return (
      <div className="navbar px-3.5 lg:px-25 bg-base-100 shadow-sm sticky top-0 z-50">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    >
                        ...
                        {/* Theme toggle - now always visible in mobile menu */}
                ...
                <div className="flex items-center gap-2 font-extrabold text-[18px] lg:text-2xl  bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
